...
<div class="addproduct-box">
        <div class="addproduct-form">
            ...
            <div class="box-container">
                ...
                <?php
      $select_orders ="SELECT * FROM `registerd_users`";

      $select_orders_res=mysqli_query($conn,$select_orders);
      if(mysqli_num_rows($select_orders_res)>0){
         while($fetch_userdetails = mysqli_fetch_assoc($select_orders_res)){ 
   ...
   ?>
                <div class="box">
                    ...
                    <table border="1" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td><p><?= $fetch_userdetails['full_name']; ?></td>
                                <td><?= $fetch_userdetails['email']; ?></p></td>
                                <td><?= $fetch_userdetails['phone']; ?></p></td>
                                <td><?= $fetch_userdetails['address']; ?></p></td>
         ...
         echo '<p class="empty">no Registerd user!</p>';
      }
   ?>
